...
// FindNeedUTXOs 找到满足转账条件，未消费过的，合理的utxo的集合
...
// FindUTXOTransactions 返回指定地址的 Transaction集合
...
// FindTransactionByTXid 根据id查找交易本身，需要遍历整个区块链
